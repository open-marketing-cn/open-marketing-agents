...
<svelte:head>
  <title>开源工具｜Open Marketing</title>
...
<div class="page-shell home-page">
  ...
  <main>
    <section class="hero-section" aria-labelledby="hero-title">
      <div class="hero-copy">
        <p class="eyebrow"><span aria-hidden="true"></span> OPEN MARKETING · TOOLS</p>
